...
int main (){
    ...
    genome.addConnection(0,3,getRandNum(-2,2), true,0); 
    genome.addConnection(1,3,getRandNum(-2,2), false,1); 
    genome.addConnection(2,3,getRandNum(-2,2), true,2); 
    genome.addConnection(1,4,getRandNum(-2,2), true,3); 
    genome.addConnection(4,3,getRandNum(-2,2), true,4); 
    genome.addConnection(0,4,getRandNum(-2,2), true,5); 
